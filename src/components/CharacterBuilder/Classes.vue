                    ...
                    <div class="classes">
                        ...
                        <div class="class-picker">
                            <div v-for="(cl, index) in basicClasses" :key="index" class="mt-6">
                                ...
                                <div class="d-flex">
                                    <v-btn v-ripple=false elevation="0" class="class-btn btn-red"
                                        @click="chooseDiscipline(cl, 1)">{{
                                            cl.class_1 }}</v-btn>
                                    <v-btn v-ripple=false elevation="0" class="class-btn btn-blue ml-3"
                        ...
                        <div v-if="chosenDisc" class="details-container  d-flex">
                                ...
                                <v-virtual-scroll :height="696" :items="chosenFeatures">
                                    <template v-slot:default="{ item }">
                                        <div :class="{'skill':true,'selected-skill':item.selected}" >
                                            <div :class="{'skill-header':true, 'd-flex':true, 'selected-skill-header':item.selected}">
                                                <v-spacer></v-spacer>
                            ...
                            <div class="attributes-container">
                                <div class="d-flex">
                                    ...
                                    <v-spacer></v-spacer>
                                    <Select v-model="chosenRank" @update:modelValue="updateFeatures" scrollHeight="fit-content" :options="ranks" class="select-rank" placeholder="Rank" />
                                    <v-btn class="select-btn" @click="chooseClass"> Add Class </v-btn>
                                    <v-spacer></v-spacer>
                                ...
                                <div class="advancement">
                                    ...
                                    <div v-for="cl in advancement">
                                        ...
                                        <div class="d-flex">
                                            <v-btn v-ripple=false elevation="0" class="class-btn btn-purple">{{
                                                cl.class_1 }}</v-btn>
                                            <v-btn v-ripple=false elevation="0" class="class-btn btn-orange  ml-3">{{
                                                cl.class_2 }}</v-btn>
                                        </div>
                                    </div>
                                </div>
        ...
        <v-col style="width: 20%;">
            <div class="chosen-container">
                <div class="player-class" v-for="cl in playerList">
                    ...
                    <div class="pclass-feat" v-for="feat in cl.features"> {{ feat.name + ' - ' + feat.description }} </div>
                </div>
            </div>
        </v-col>
    </div>
